...
const session = require('express-session'); //เก็บไว้ใน session เพื่อเรียกใช้งานทีหลัง
const passport = require('passport');
const LocalStrategy = require('passport-local').Strategy; // สำหรับตรวจสอบผู้ใช้และรหัส 
